...
int explorer_comm_open(explorer_comm_t * r, int drivemotor_center)
{
    struct termios term;
    int flags;
    ...
    if (explorer_comm_init(r, drivemotor_center) < 0)
    {
...
int explorer_comm_init(explorer_comm_t * r, int drivemotor_center)
{
...
int explorer_comm_setServo(explorer_comm_t * r, const int which, const int value) {

    setServo(r, which, value);
