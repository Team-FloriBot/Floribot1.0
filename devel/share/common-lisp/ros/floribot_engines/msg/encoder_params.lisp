...
(cl:in-package floribot_engines-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <encoder_params>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'encoder_params)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name floribot_engines-msg:<encoder_params> is deprecated: use floribot_engines-msg:encoder_params instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <encoder_params>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-msg:header-val is deprecated.  Use floribot_engines-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <encoder_params>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-msg:index-val is deprecated.  Use floribot_engines-msg:index instead.")
  (index m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <encoder_params>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-msg:count-val is deprecated.  Use floribot_engines-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'count_change-val :lambda-list '(m))
(cl:defmethod count_change-val ((m <encoder_params>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-msg:count_change-val is deprecated.  Use floribot_engines-msg:count_change instead.")
  (count_change m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <encoder_params>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-msg:time-val is deprecated.  Use floribot_engines-msg:time instead.")
  (time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<encoder_params>)))
  ...
  "floribot_engines/encoder_params")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'encoder_params)))
  "Returns string type for a message object of type 'encoder_params"
  "floribot_engines/encoder_params")
