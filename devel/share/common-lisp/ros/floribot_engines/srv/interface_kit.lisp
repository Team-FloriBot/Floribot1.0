...
(cl:in-package floribot_engines-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <interface_kit-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'interface_kit-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name floribot_engines-srv:<interface_kit-request> is deprecated: use floribot_engines-srv:interface_kit-request instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <interface_kit-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-srv:index-val is deprecated.  Use floribot_engines-srv:index instead.")
  (index m))

(cl:ensure-generic-function 'value_type-val :lambda-list '(m))
(cl:defmethod value_type-val ((m <interface_kit-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-srv:value_type-val is deprecated.  Use floribot_engines-srv:value_type instead.")
  (value_type m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <interface_kit-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-srv:value-val is deprecated.  Use floribot_engines-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<interface_kit-request>)))
  ...
  "floribot_engines/interface_kitRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'interface_kit-request)))
  "Returns string type for a service object of type 'interface_kit-request"
  "floribot_engines/interface_kitRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <interface_kit-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'interface_kit-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name floribot_engines-srv:<interface_kit-response> is deprecated: use floribot_engines-srv:interface_kit-response instead.")))

(cl:ensure-generic-function 'ack-val :lambda-list '(m))
(cl:defmethod ack-val ((m <interface_kit-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader floribot_engines-srv:ack-val is deprecated.  Use floribot_engines-srv:ack instead.")
  (ack m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<interface_kit-response>)))
  ...
  "floribot_engines/interface_kitResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'interface_kit-response)))
  "Returns string type for a service object of type 'interface_kit-response"
  "floribot_engines/interface_kitResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'interface_kit)))
  ...
  "floribot_engines/interface_kit")